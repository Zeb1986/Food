...
function forms(fotmSelector, modalTimerId) {
  //FORMS

  const forms = document.querySelectorAll(fotmSelector);
  ...
  function showThanksModal(message) {
    ...
    <div data-close class="modal__close" data-close>×</div>
...
window.addEventListener('DOMContentLoaded', () => {
    const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerId), 6000);

      (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__.default)('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
      (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.default)('[data-modal]', '.modal', modalTimerId);
      (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2021-02-28');
